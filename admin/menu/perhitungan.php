...
<section class="content-header">
	<h1>
		<i class="fa fa-key"></i> Perhitungan
	</h1>
	<?php
	$pelamar = new Pelamar();
						...
						<div class="box-body">
							...
							<table class="table table-bordered table-striped table-hover">
								<form class="form-horizontal row-fluid" action="index.php?menu=pelamar" method="get">
									...
									<tbody>
										<th class="center"><input type="hidden" name="menu" value="perhitungan">
											<div class="controls">
		...
		?>
			<section class="content">
				...
				<div class="module-footer">
					<center><?php echo "<a href='?menu=perhitungan&penerimaan=$id_lowongan&hitung=1' class= 'btn btn-primary'>Hitung</a>"; ?> </center>
				</div>
				<br>
				...
				?>
					...
					<table class="table table-bordered table-striped table-hover">
						...
						for ($i = 0; $i < $jml_pelamar; $i++) {
							...
							echo "<th class = 'center'>Pelamar dengan id " . $ar_pelamar[$i] . "<br>";
							$ib = 0;
							$vkt_s = 1;
							while ($k = $loop2->fetch()) {
							...
							echo "Vektor s pelamar " . $ar_pelamar[$i] . " = " . $vkt_s . "<br></th>";
