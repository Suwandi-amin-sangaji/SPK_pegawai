...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Manager Panel | BANK PAPUA</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=home" class="logo">
          <img style="margin-top:-5px;margin-right:1px" src="../img/favpapua.png" alt="Logo" height="30pt"> 
          <span style="font-size:20px;color:#2a388a"><b>BANK PAPUA</b></span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2021 - <a href="">BizLand</a></strong>
      </footer>
    </div><!-- ./wrapper -->
